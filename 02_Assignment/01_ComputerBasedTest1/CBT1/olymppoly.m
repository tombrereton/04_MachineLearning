...
%% Linear model
plotx = [x(1)-2:0.1:x(end)+2]'; %% what is this function?, generating some values for x which we will use to plot w with
X = [];
plotX = [];
for k = 0:1
    X = [X x.^k];
